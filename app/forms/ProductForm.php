...
class ProductForm extends Form {
    ...
    public function initialize(){
        ...
        $this->add(new Text('current_price',['class'=>'form-control']));
        $this->add(new Text('old_price',['class'=>'form-control']));
        ...
        if($cat = $this->request->getPost('cat_id')){ $this->add(new Select('cat_id',Catalog::find(),['using'=>['id','name'],'class'=>'form-control','value'=>$cat])); }
        else { $this->add(new Select('cat_id',Catalog::find(),['using'=>['id','name'],'class'=>'form-control'])); }
    }
